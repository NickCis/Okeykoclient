...
print "SE ESTA IMPORTANDO libokeyko BASADO EN BEAUTIFULSOUP. ESTA VERSION NO ESTA COMPLETAMENTE DESARROLLADA\n" \
      "ES UNA VERSION VIEJA QUE SE DEJO PARA PRUEBAS DE VELOCIDAD. MUCHAS DE LAS COSAS NO ESTAN IMPLEMENTADAS\n"\
      "NI ARREGLADAS. POR FAVOR IMPORTE libokeyko\n"\
      "SI ESTE MENSAJE SALE AUTOMATICAMENTE, ASEGURESE DE QUE SE CUMPLAN LAS DEPENDENCIAS DE pyQuery\n"\
      "PYQUERY ESTA INTEGRADO A OKEYKO, SE NECECITAN LAS DEPENDENCIAS INSLATADAS, NO PYQUERY\n"\
      "BASICAMENTE ESTAS SON LXML"
