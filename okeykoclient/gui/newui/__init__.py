...
import gui.gtkui.TrayIcon as TrayIcon
import gui.gtkui.Notification as Notification
...
def gtk_main(Control):
    ...
    MainWindow = MW.MainWindow(Control)
    Control.update({'MainWindow': MainWindow})
    
    #EventHandler = EH.EventHandler(Control, MainWindow.WebEngine)
    EventHandler = MainWindow.WebEngine.getEventHandler()
    Control.update({'EventHandler': EventHandler})
