...
if os.name == 'nt':
    ...
    opts = {
        'py2exe': {
            'packages': ['encodings', 'gtk', 'gzip', 'lxml'],
    ...
    setup(requires    = ["gtk"],
        windows        = [{"script": "okeykoclient.py", 'icon_resources': [(1, "okeykoclient.ico")], "dest_base": "okeykoclient"}],
        console        = [{"script": "okeykoclient.py", "dest_base": "okeykoclient_debug"}],
        options        = opts,
